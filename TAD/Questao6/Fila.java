...
public class Fila {
    ...
    //Exercício 6
    public void SepararF(int[] fila, int[] filaPar, int[] filaImpar){
    	//verifica se a fila esta preenchida
        while(primeiraPosicaoFila < fila.length){ 
    ...
    public void ExibirF(){
    	System.out.println("\n");
        System.out.println("FILA PRINCIPAL");
        for(int i = ultimaPosicaoFila; i<n; i++) {
            System.out.println("Posicao: " + i + " Elemento: " + FilaPadrao[i]);
        }
        System.out.println("\n");
